...
public class RequestCollabId implements Serializable {
    private String oidUserShare;
    private Board board; // Assuming Board uses its primary key for equality checks

    public RequestCollabId() {
    }

    public RequestCollabId(String oidUserShare, Board board) {
    ...
    public boolean equals(Object o) {
        ...
        RequestCollabId that = (RequestCollabId) o;
